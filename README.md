...
- Analyze the text into simple sections
- Automatically store analyzed results in **History**
- Save important results in a separate **Saved** tab
...
```text
Your assignment must be submitted on Canvas by Friday at 11:59 PM. Late work loses 10% per day.
